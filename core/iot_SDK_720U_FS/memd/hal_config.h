 ...
 * build target
 */
#define CONFIG_BUILD_TARGET "8915DM_cat1_CUSTOMIZE_CSDK_FS"

/**
 * Build identify string
 */
#define CONFIG_BUILD_IDENTIFY "8915DM_cat1_CUSTOMIZE_CSDK_FS-debug-DEVEL-svn2117"
 ...
 */
#define CONFIG_APPIMG_FLASH_SIZE 0x90000
 ...
 */
#define CONFIG_FS_SYS_FLASH_ADDRESS 0x60240000

/*+\NEW\zhuwangbin\2020.8.15\兼容1.2V, offset未定义导致CSDK无法升级问题*/
#define CONFIG_FS_SYS_FLASH_OFFSET 0x240000
/*-\NEW\zhuwangbin\2020.8.15\兼容1.2V, offset未定义导致CSDK无法升级问题*/
