...
#define LV_LOG_TRACE(dsc) OSI_LOGD(0, dsc); // lv_log_add(LV_LOG_LEVEL_TRACE, __FILE__, __LINE__, dsc);
#else
...
#define LV_LOG_INFO(dsc) OSI_LOGI(0, dsc); // lv_log_add(LV_LOG_LEVEL_INFO, __FILE__, __LINE__, dsc);
#else
...
#define LV_LOG_WARN(dsc) OSI_LOGW(0, dsc); // lv_log_add(LV_LOG_LEVEL_WARN, __FILE__, __LINE__, dsc);
#else
...
#define LV_LOG_ERROR(dsc) OSI_LOGE(0, dsc); // lv_log_add(LV_LOG_LEVEL_ERROR, __FILE__, __LINE__, dsc);
#else
