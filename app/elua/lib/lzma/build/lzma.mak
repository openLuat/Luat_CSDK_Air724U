...
#=========================================================================
# File Name      : lzma.mak
# Description    : Main make file for the /lzma package.
#
# Usage          : make [-s] -f lzma.mak OPT_FILE=<path>/<opt_file>
#
...
PACKAGE_SRC_FILES += LzmaDec.c \
                     LzmaLib.c


# These are the tool flags specific to the lzma package only.
