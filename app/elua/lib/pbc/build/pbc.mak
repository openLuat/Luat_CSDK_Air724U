...
#=========================================================================
# File Name      : crypto.mak
# Description    : Main make file for the /json package.
#
# Usage          : make [-s] -f json.mak OPT_FILE=<path>/<opt_file>
#
...
PACKAGE_NAME     = elua/lib/pbc
PACKAGE_BASE     = luat
PACKAGE_DEP_FILE = pbc_dep.mak
...
# These are the tool flags specific to the json package only.
