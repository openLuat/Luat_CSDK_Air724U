...
#=========================================================================
# File Name      : lpng_pal.mak
# Description    : Main make file for the /lpng_pal package.
#
# Usage          : make [-s] -f lpng_pal.mak OPT_FILE=<path>/<opt_file>
#
...
PACKAGE_NAME     = lpng_pal
PACKAGE_BASE     = luat
PACKAGE_DEP_FILE = lpng_pal_dep.mak
PACKAGE_PATH     = $(BUILD_ROOT)/$(PACKAGE_BASE)/elua/lib/lpng/$(PACKAGE_NAME)
...
# These are the tool flags specific to the lpng_pal package only.
