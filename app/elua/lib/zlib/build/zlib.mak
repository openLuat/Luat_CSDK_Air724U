...
#=========================================================================
# File Name      : zlib.mak
# Description    : Main make file for the /zlib package.
#
# Usage          : make [-s] -f zlib.mak OPT_FILE=<path>/<opt_file>
#
...
PACKAGE_INC_PATHS   =   $(PACKAGE_PATH)/zlib_pal/include \
                        $(PACKAGE_PATH)/src \
...
# These are the tool flags specific to the zlib package only.
