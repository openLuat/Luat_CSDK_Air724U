...
#=========================================================================
# File Name      : shell.mak
# Description    : Main make file for the /shell package.
#
# Usage          : make [-s] -f shell.mak OPT_FILE=<path>/<opt_file>
#
...
PACKAGE_NAME     = shell
PACKAGE_BASE     = elua
PACKAGE_DEP_FILE = shell_dep.mak
...
PACKAGE_SRC_FILES  = shell.c \
                     ini_parser.c \


# These are the tool flags specific to the shell package only.
